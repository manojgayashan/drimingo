import { View, Text, Image, TouchableOpacity, Dimensions, Switch, TextInput, FlatList } from 'react-native'
            ...
            {step == 1 ?
                <>
                    <View style={CommanStyles.row}>
                        ...
                        <Text style={CommanStyles.font18}>Join Now</Text>
                    </View>
                    <View>
                        <View style={CommanStyles.innerContainer}>
                            <View>
                                <View style={CommanStyles.row}>
                                    ...
                                    <Image source={require('../../assets/images/rocket-launch-md.png')} style={CommanStyles.mediumIcon} />
                                </View>
                                <DgoTextInput
                                    value={email}
                                ...
                                <DgoButton
                                    ...
                                    onPress={() => setStep(2)}
                                />
                                <Text style={[CommanStyles.font12, { marginTop: 10, textAlign: 'center' }]}>By continuing you agree to Drimingo Pvt Ltd's <Text style={{ color: Colors.dgo_blue_200 }}>Terms & Conditions</Text> and <Text style={{ color: Colors.dgo_blue_200 }}>Privacy Policy</Text> We only use your data to offer a personalized experience.</Text>
                            </View>
                            <View>
                            ...
                            cityOpen ?
                                ...
                                <>
                                    <View style={CommanStyles.row}>
                                        ...
                                        <Text style={CommanStyles.font18}>Basic Info</Text>
                                    </View>
                    ...
                    step == 3 ?
                        <>
                            <View style={CommanStyles.row}>
                                ...
                                <Text style={CommanStyles.font18}>Password</Text>
                            </View>
                        ...
                        step == 4 ?
                            <>
                                <View style={CommanStyles.row}>
                                    ...
                                    <Text style={CommanStyles.font18}>Confirm Your Email</Text>
                                </View>
                                <Animatable.View key={step4Key} animation={'fadeInRight'}>
                                    <View style={CommanStyles.innerContainer}>
                                        <View>
                                            <Text style={[CommanStyles.font12, { paddingVertical: 5, marginBottom: 10 }]}>You'll receive a temporary reset code via email. Please enter it below.</Text>
                                    ...
                                    <Animatable.View key={step5Key} animation={'fadeInUp'}>
                                        <View style={CommanStyles.innerContainer}>
                                            <View style={CommanStyles.center}>
                                                ...
                                                <Text style={[CommanStyles.font12, { paddingVertical: 20, textAlign: 'center' }]}>You have successfully created your free account. Start to plan your dream tour with Drimingo.</Text>
                                                <Image source={require('../../assets/images/login-welcome-md.png')} style={CommanStyles.bigIcon} />
                                            </View>
                                            <View>
                                                <View style={[CommanStyles.row, { justifyContent: 'space-between' }]}>
                                                    <Text style={[CommanStyles.font12, { color: Colors.dgo_black_100, padding: 10, width: windowWidth - 100 }]}>Enable location access for better recommendation and directional guide.</Text>
