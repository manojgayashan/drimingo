...
export default function SignIn({ onClose,animation,joinNowBottomSheetRef,forgotPasswordBottomSheetRef }) {
    ...
    return (
        <View style={CommanStyles.appContainer}>
            <View style={CommanStyles.row}>
                ...
                <Text style={CommanStyles.font18}>Sign In with Email</Text>
            </View>
            <View>
                <View style={CommanStyles.innerContainer}>
                    <View>
                        <View style={CommanStyles.row}>
                            ...
                            <Image source={require('../../assets/images/login-welcome-md.png')} style={CommanStyles.mediumIcon} />
                        </View>
                        <DgoTextInput
                            value={email}
                        ...
                        />
                        <Text style={[CommanStyles.font12, { marginTop: 10, textAlign: 'center' }]}>By signing in, you agree to Drimingo Pvt Ltd's <Text style={{ color: Colors.dgo_blue_200 }}>Terms & Conditions</Text> and <Text style={{ color: Colors.dgo_blue_200 }}>Privacy Policy</Text>.</Text>
                    </View>
                    <View>
